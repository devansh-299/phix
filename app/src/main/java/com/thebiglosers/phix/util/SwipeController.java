package com.thebiglosers.phix.util;
    ...
    private void setTouchListener(final Canvas c,
        ...
        recyclerView.setOnTouchListener((v, event) -> {
            swipeBack = event.getAction() ==
                    MotionEvent.ACTION_CANCEL || event.getAction() == MotionEvent.ACTION_UP;
            if (swipeBack) {
